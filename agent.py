...
class AlienSeqDataset(Dataset):
    def __init__(self, file, seq_len=5):
        ...
        # Prevent extreme singularities during data loading
...
def hybrid_loss(model, seq_coords, true_accel, lambda_phys=2.0):
    ...
    # 🔴 FIX: Clamp 'r' so it NEVER hits 0, preventing NaN explosions
...
if __name__ == "__main__":
    ...
    for epoch in range(201):
        ...
        for i in range(0, dataset_size, batch_size):
            ...
            # Contiguous memory prevents GRU C++ crashes
